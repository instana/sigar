...
$CC $CFLAGS -I./include -c src/sigar.c -o $BUILD_DIR/sigar.o
$CC $CFLAGS -I./include -c src/sigar_cache.c -o $BUILD_DIR/sigar_cache.o
$CC $CFLAGS -I./include -c src/sigar_fileinfo.c -o $BUILD_DIR/sigar_fileinfo.o
$CC $CFLAGS -I./include -c src/sigar_format.c -o $BUILD_DIR/sigar_format.o
$CC $CFLAGS -I./include -c src/sigar_getline.c -o $BUILD_DIR/sigar_getline.o
$CC $CFLAGS -I./include -c src/sigar_ptql.c -o $BUILD_DIR/sigar_ptql.o
$CC $CFLAGS -I./include -c src/sigar_signal.c -o $BUILD_DIR/sigar_signal.o
$CC $CFLAGS -I./include -c src/sigar_util.c -o $BUILD_DIR/sigar_util.o
